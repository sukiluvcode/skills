...
# seqlbtoolkit.base_model.eval.Metric is used only in (annotation-only)
# type hints below; alias to Any to drop the heavy seqlbtoolkit/torch dep.
from typing import Any as Metric
